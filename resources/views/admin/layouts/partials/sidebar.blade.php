    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('admin/event-categoris') ? 'active' : '' }}"
                        href="/admin/event-categoris">
                        <span class="menu-icon">
                            <i class="bi bi-person fs-3"></i>
                        </span>
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('admin/events') ? 'active' : '' }}" href="admin/events">
                        <span class="menu-icon">
                            <i class="bi bi-person fs-3"></i>
                        </span>
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Notice Management</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('admin/notice-categoris') ? 'active' : '' }}"
                        href="/admin/notice-categoris">
                        <span class="menu-icon">
                            <i class="bi bi-person fs-3"></i>
                        </span>
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::is('admin/notices') ? 'active' : '' }}" href="admin/notices">
                        <span class="menu-icon">
                            <i class="bi bi-person fs-3"></i>
                        </span>
