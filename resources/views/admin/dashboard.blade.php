                ...
                <div class="col-xl-4">
                    ...
                    <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total Service</div>
                            <div class="fw-bold text-white">14</div>
                        </div>
                        <!--end::Body-->
                    </a>
                ...
                <div class="col-xl-4">
                    ...
                    <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">Total Partner</div>
                            <div class="fw-bold text-white">20</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
